 ...
 * ****************************************************************************** List Orders By
 * Next Token Response API Version: 2013-09-01 Library Version: 2018-08-01 Generated: Wed Aug 29
 * 10:45:06 PDT 2018
 */
...
public class ListOrdersByNextTokenResponse extends AbstractMwsObject implements MwsResponse {
   ...
   *
   * @param listOrdersByNextTokenResult The new value to set.
   */
   ...
   *
   * @param responseHeaderMetadata The new value to set.
   */
  @Override
  ...
  public void readFragmentFrom(MwsReader r) {
    listOrdersByNextTokenResult =
        r.read("ListOrdersByNextTokenResult", ListOrdersByNextTokenResult.class);
  ...
  public void writeTo(MwsWriter w) {
    w.write(
        "https://mws.amazonservices.com/Orders/2013-09-01", "ListOrdersByNextTokenResponse", this);
  }
