...
public class ChannelController {
  ...
  public ChannelController(
      ChannelService channelService, ChannelCache channelCache, LabelCache labelCache) {
  ...
  public Json list() {
    ...
    channelList.forEach(
        channelLabel ->
            channelLabel.setPartnerDesc(
                labelCache.getLabel("carrier_" + channelLabel.getPartner())));
