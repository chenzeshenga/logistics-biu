 ...
 * ****************************************************************************** List Orders
 * Request API Version: 2013-09-01 Library Version: 2018-08-01 Generated: Wed Aug 29 10:45:06 PDT
 * 2018
 */
...
public class ListOrdersRequest extends AbstractMwsObject {
   ...
   *
   * @param createdAfter The new value to set.
   */
   ...
   *
   * @param createdBefore The new value to set.
   */
   ...
   *
   * @param lastUpdatedAfter The new value to set.
   */
   ...
   *
   * @param lastUpdatedBefore The new value to set.
   */
   ...
   *
   * @param orderStatus New values to add.
   * @return This instance.
   */
   ...
   *
   * @param marketplaceId New values to add.
   * @return This instance.
   */
   ...
   *
   * @param fulfillmentChannel New values to add.
   * @return This instance.
   */
   ...
   *
   * @param paymentMethod New values to add.
   * @return This instance.
   */
   ...
   *
   * @param maxResultsPerPage The new value to set.
   */
   ...
   *
   * @param tfmShipmentStatus New values to add.
   * @return This instance.
   */
  ...
  public void writeFragmentTo(MwsWriter w) {
    ...
    ids.add("A1VC38T7YXB528");
    w.writeList("MarketplaceId", "Id", ids);
  }
