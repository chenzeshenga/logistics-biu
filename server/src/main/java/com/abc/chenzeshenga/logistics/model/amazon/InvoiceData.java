...
public class InvoiceData extends AbstractMwsObject {
     ...
     *
     * @param invoiceRequirement The new value to set.
     */
     ...
     *
     * @param buyerSelectedInvoiceCategory The new value to set.
     */
     ...
     *
     * @param invoiceTitle The new value to set.
     */
     ...
     *
     * @param invoiceInformation The new value to set.
     */
