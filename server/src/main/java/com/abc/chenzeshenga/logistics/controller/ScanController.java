 ...
 * @version 1.0
 */
@RestController @RequestMapping("/scan") @Slf4j public class ScanController {

    @Value("${logistics.base.url}") private String baseUrl;

    @Resource private OrderMapper orderMapper;

    @Resource private ProductMapper productMapper;

    @GetMapping("/ord/content/{ordno}") public Json getOrdContent(@PathVariable String ordno) {
