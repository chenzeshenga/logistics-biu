 ...
 * ****************************************************************************** List Orders By
 * Next Token Result API Version: 2013-09-01 Library Version: 2018-08-01 Generated: Wed Aug 29
 * 10:45:06 PDT 2018
 */
...
public class ListOrdersByNextTokenResult extends AbstractMwsObject {
   ...
   *
   * @param nextToken The new value to set.
   */
   ...
   *
   * @param orders The new value to set.
   */
   ...
   *
   * @param orders New values to add.
   * @return This instance.
   */
  ...
  public void writeTo(MwsWriter w) {
    w.write(
        "https://mws.amazonservices.com/Orders/2013-09-01", "ListOrdersByNextTokenResult", this);
  }
