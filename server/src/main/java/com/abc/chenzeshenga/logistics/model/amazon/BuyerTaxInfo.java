...
public class BuyerTaxInfo extends AbstractMwsObject {
   ...
   *
   * @param companyLegalName The new value to set.
   */
   ...
   *
   * @param taxingRegion The new value to set.
   */
   ...
   *
   * @param taxClassifications The new value to set.
   */
   ...
   *
   * @param taxClassifications New values to add.
   * @return This instance.
   */
  ...
  public void readFragmentFrom(MwsReader r) {
    ...
    taxClassifications =
        r.readList("TaxClassifications", "TaxClassification", TaxClassification.class);
  }
