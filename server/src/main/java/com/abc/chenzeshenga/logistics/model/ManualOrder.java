...
public class ManualOrder extends BaseRowModel implements Serializable {
    ...
    @ExcelProperty(index = 23, value = "订单费用(JPY)")
    private String ordUserFee;

    @ExcelProperty(index = 24, value = "东岳sku")
    private String sku1;
    ...
    @ExcelProperty(index = 27, value = "东岳sku")
    private String sku2;
    ...
    @ExcelProperty(index = 30, value = "东岳sku")
    private String sku3;

    @ExcelProperty(index = 31, value = "名称")
    private String name3;

    @ExcelProperty(index = 32, value = "数量")
    private String num3;
