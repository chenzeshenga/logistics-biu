 ...
 * @since 2019.7.19
 */
@Data @AllArgsConstructor @NoArgsConstructor @ToString @TableName("l_returning") public class Return
  implements Serializable {

  private static final long serialVersionUID = -6249013466703476021L;

  @TableId(type = IdType.ID_WORKER_STR) private String returnNo;
  ...
  @TableField(value = "create_by") private String creator;
  @TableField(value = "update_by") private String updator;
  private String orderNo;
  @TableField(exist = false) private List<ReturnContent> contentList;
}
