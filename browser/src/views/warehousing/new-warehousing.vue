            ...
            <el-form ref="form" label-width="120px" :model="form">
                ...
                <el-form-item label="关税相关">
                    ...
                    <el-col :span="12">
                        <el-form-item label="关税类型">
                            <el-radio v-model="form.taxType" label="预缴关税"
                            >预缴关税
                            </el-radio>
                            <el-radio v-model="form.taxType" label="实报实销"
                            >实报实销
                            </el-radio>
                        </el-form-item>
                    </el-col>
                ...
                <el-form-item label="入库商品">
                    ...
                    <el-col :span="4" style="margin-top: 22px">
                        <el-button type="primary" @click="add2Cart"
                        >添加
                        </el-button>
                    </el-col>
                </el-form-item>
