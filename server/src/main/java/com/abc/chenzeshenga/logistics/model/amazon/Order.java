 ...
 * ****************************************************************************** Order API Version:
 * 2013-09-01 Library Version: 2018-08-01 Generated: Wed Aug 29 10:45:06 PDT 2018
 */
 ...
 *             &lt;element name="ShippingAddress" type="{https://mws.amazonservices.com/Orders/2013-09-01}JpAddress" minOccurs="0"/&gt;
...
public class Order extends AbstractMwsObject {
   ...
   *
   * @param sellerOrderId The new value to set.
   */
   ...
   *
   * @param purchaseDate The new value to set.
   */
   ...
   *
   * @param lastUpdateDate The new value to set.
   */
   ...
   *
   * @param orderStatus The new value to set.
   */
   ...
   *
   * @param fulfillmentChannel The new value to set.
   */
   ...
   *
   * @param salesChannel The new value to set.
   */
   ...
   *
   * @param orderChannel The new value to set.
   */
   ...
   *
   * @param shipServiceLevel The new value to set.
   */
   ...
   *
   * @param shippingAddress The new value to set.
   */
   ...
   *
   * @param orderTotal The new value to set.
   */
   ...
   *
   * @param numberOfItemsShipped The new value to set.
   */
   ...
   *
   * @param numberOfItemsUnshipped The new value to set.
   */
   ...
   *
   * @param paymentExecutionDetail The new value to set.
   */
   ...
   *
   * @param paymentExecutionDetail New values to add.
   * @return This instance.
   */
   ...
   *
   * @param paymentMethodDetails The new value to set.
   */
   ...
   *
   * @param paymentMethodDetails New values to add.
   * @return This instance.
   */
   ...
   *
   * @param marketplaceId The new value to set.
   */
   ...
   *
   * @param buyerEmail The new value to set.
   */
   ...
   *
   * @param buyerName The new value to set.
   */
   ...
   *
   * @param buyerCounty The new value to set.
   */
   ...
   *
   * @param buyerTaxInfo The new value to set.
   */
   ...
   *
   * @param shipmentServiceLevelCategory The new value to set.
   */
   ...
   *
   * @param shippedByAmazonTFM The new value to set.
   */
   ...
   *
   * @param tfmShipmentStatus The new value to set.
   */
   ...
   *
   * @param cbaDisplayableShippingLabel The new value to set.
   */
   ...
   *
   * @param orderType The new value to set.
   */
   ...
   *
   * @param earliestShipDate The new value to set.
   */
   ...
   *
   * @param latestShipDate The new value to set.
   */
   ...
   *
   * @param earliestDeliveryDate The new value to set.
   */
   ...
   *
   * @param latestDeliveryDate The new value to set.
   */
   ...
   *
   * @param isBusinessOrder The new value to set.
   */
   ...
   *
   * @param purchaseOrderNumber The new value to set.
   */
   ...
   *
   * @param isPrime The new value to set.
   */
   ...
   *
   * @param isPremiumOrder The new value to set.
   */
   ...
   *
   * @param replacedOrderId The new value to set.
   */
   ...
   *
   * @param isReplacementOrder The new value to set.
   */
   ...
   *
   * @param promiseResponseDueDate The new value to set.
   */
   ...
   *
   * @param isEstimatedShipDateSet The new value to set.
   */
