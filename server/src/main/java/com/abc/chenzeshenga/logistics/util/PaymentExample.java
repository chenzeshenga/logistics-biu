...
public class PaymentExample {
    ...
    @Before public void init() {
        ...
        //        RowRenderData header = RowRenderData
        //            .build(new TextRenderData("日期", headTextStyle), new TextRenderData("订单编号", headTextStyle),
        //                new TextRenderData("销售代表", headTextStyle), new TextRenderData("离岸价", headTextStyle),
        //                new TextRenderData("发货方式", headTextStyle), new TextRenderData("条款", headTextStyle),
        ...
        //            new MiniTableRenderData(header, Arrays.asList(row), MiniTableRenderData.WIDTH_A4_MEDIUM_FULL);
        ...
        datas.setDeliverDate("xxx");
        datas.setTrackNo("xx");
        datas.setTotalPrice("9999");
    }
