...
public class MarketplaceWebServiceOrdersConfig {
  ...
  public void setUserAgent(
    ...
    cc.setUserAgent(
        applicationName, applicationVersion, programmingLanguage, additionalNameValuePairs);
  }
   ...
   *
   * <p>This can either be just the host name or can include the full path to the service.
   *
  ...
  public void setServiceURL(String serviceUrl) {
    try {
      ...
      URI partialURI =
          new URI(
              fullURI.getScheme(), null, fullURI.getHost(), fullURI.getPort(), null, null, null);
   ...
   *
   * <p>This is the max number of requests to queue before executing requests on the calling thread.
   *
   ...
   *
   * <p>This is the number of async threads to process requests from the queue.
   *
