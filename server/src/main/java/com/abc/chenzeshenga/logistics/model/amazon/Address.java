...
public class Address extends AbstractMwsObject {
   ...
   *
   * @param addressLine3 The new value to set.
   */
   ...
   *
   * @param county The new value to set.
   */
   ...
   *
   * @param district The new value to set.
   */
   ...
   *
   * @param stateOrRegion The new value to set.
   */
   ...
   *
   * @param municipality The new value to set.
   */
   ...
   *
   * @param postalCode The new value to set.
   */
   ...
   *
   * @param countryCode The new value to set.
   */
   ...
   *
   * @param addressType The new value to set.
   */
  ...
  public void writeTo(MwsWriter w) {
    w.write("https://mws.amazonservices.com/Orders/2013-09-01", "JpAddress", this);
  }
