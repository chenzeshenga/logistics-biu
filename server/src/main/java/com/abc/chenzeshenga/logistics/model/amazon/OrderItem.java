...
public class OrderItem extends AbstractMwsObject {
   ...
   *
   * @param asin The new value to set.
   */
   ...
   *
   * @param sellerSKU The new value to set.
   */
   ...
   *
   * @param orderItemId The new value to set.
   */
   ...
   *
   * @param quantityOrdered The new value to set.
   */
   ...
   *
   * @param quantityShipped The new value to set.
   */
   ...
   *
   * @param productInfo The new value to set.
   */
   ...
   *
   * @param pointsGranted The new value to set.
   */
   ...
   *
   * @param itemPrice The new value to set.
   */
   ...
   *
   * @param shippingPrice The new value to set.
   */
   ...
   *
   * @param giftWrapPrice The new value to set.
   */
   ...
   *
   * @param itemTax The new value to set.
   */
   ...
   *
   * @param shippingTax The new value to set.
   */
   ...
   *
   * @param giftWrapTax The new value to set.
   */
   ...
   *
   * @param shippingDiscount The new value to set.
   */
   ...
   *
   * @param shippingDiscountTax The new value to set.
   */
   ...
   *
   * @param promotionDiscount The new value to set.
   */
   ...
   *
   * @param promotionDiscountTax The new value to set.
   */
   ...
   *
   * @param promotionIds The new value to set.
   */
   ...
   *
   * @param promotionIds New values to add.
   * @return This instance.
   */
   ...
   *
   * @param codFee The new value to set.
   */
   ...
   *
   * @param codFeeDiscount The new value to set.
   */
   ...
   *
   * @param isGift The new value to set.
   */
   ...
   *
   * @param giftMessageText The new value to set.
   */
   ...
   *
   * @param giftWrapLevel The new value to set.
   */
   ...
   *
   * @param invoiceData The new value to set.
   */
   ...
   *
   * @param conditionNote The new value to set.
   */
   ...
   *
   * @param conditionId The new value to set.
   */
   ...
   *
   * @param conditionSubtypeId The new value to set.
   */
   ...
   *
   * @param scheduledDeliveryStartDate The new value to set.
   */
   ...
   *
   * @param scheduledDeliveryEndDate The new value to set.
   */
   ...
   *
   * @param priceDesignation The new value to set.
   */
   ...
   *
   * @param buyerCustomizedInfo The new value to set.
   */
   ...
   *
   * @param taxCollection The new value to set.
   */
  ...
  public OrderItem(
      ...
      PointsGrantedDetail pointsGranted,
      Money itemPrice,
      Money shippingPrice,
      Money giftWrapPrice,
      Money itemTax,
