...
@Slf4j public class ObjectUtil {
    ...
    public static Object reflectFromOri(Object ori, Object curr) {
        ...
        for (Field field : fields) {
            try {
                Method getMethod = ori.getClass().getMethod("get" + field.getName().substring(0, 1).toUpperCase() + field.getName().substring(1));
                Method setMethod =
                    ori.getClass().getMethod("set" + field.getName().substring(0, 1).toUpperCase() + field.getName().substring(1), oriClazz);
